...
public partial class PerfectPickUsersDbSecondContext : DbContext
{
    public PerfectPickUsersDbSecondContext()
    {
    }

    public PerfectPickUsersDbSecondContext(DbContextOptions<PerfectPickUsersDbSecondContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer(Environment.GetEnvironmentVariable("connectionSecondString"));
